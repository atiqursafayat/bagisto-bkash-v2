...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | bKash Error Message Mapping
    |--------------------------------------------------------------------------
    |
    | Maps bKash status/external codes to user-friendly messages.
    | You can extend this list based on bKash's latest error-code sheet.
    |
    */
    'error_messages' => [
